...
import com.solvd.building_house.Paintable;
...
public class Room implements Paintable {
    ...
    public void printRoomInfo() {
        LOGGER.debug("\n\nThis room " + roomType + " walls area is " + roomWallsAreaCalc()
                + " \n It's Floor is " + floor.getFloorCoverMaterial() + " and it's ceiling "
                + ceiling.getCeilingColor());
    }

    public void printRoomInfo(String wallMaterial) {
        LOGGER.debug("\n\nThis room " + roomType + " walls area is " + roomWallsAreaCalc()
                + "It's walls material is " + wallMaterial
                + " \n It's Floor is " + floor.getFloorCoverMaterial() + " and it's ceiling " + ceiling.getCeilingColor());
    }
